...
#![doc(html_root_url = "https://docs.rs/ferogram-tl-types/0.6.2")]
//! Auto-generated Telegram API types, functions, and enums for TL Layer 227.
//!
...
//! | Flag | Effect |
//! |---|---|
//! | `tl-api` | Layer 227 API schema types (default in `ferogram`) |
