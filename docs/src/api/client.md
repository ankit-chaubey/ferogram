...
<span class="api-card-sig">Client::with_string_session(session: &str, api_id: i32, api_hash: &str) → Result&lt;(Client, ShutdownToken), InvocationError&gt; <span class="api-badge-new">New 0.2.0</span></span>
</div>
<div class="api-card-body">
...
<div class="api-card-body">Lazy async iterator that pages through all members, including beyond the 200-member limit. Fixed in v0.2.0 to paginate correctly for large channels.</div>
</div>
